<template>
    <header>
        ...
        <div class="search" v-click-outside="onClickOutside">
            <svg t="1683549413993" class="icon search-icon" viewBox="0 0 1024 1024" version="1.1"
                xmlns="http://www.w3.org/2000/svg" p-id="2751" width="200" height="200">
                <path
        ...
        <div class="menu">
            <!-- 消息 -->
            <div class="message">
                <svg t="1683775348657" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    p-id="2568" data-spm-anchor-id="a313x.7781069.0.i7" width="200" height="200">
                    <path
                        ...
                        fill="#6965db" p-id="2569" data-spm-anchor-id="a313x.7781069.0.i5" class="selected"></path>
                    <path
                        ...
                        fill="#6965db" p-id="2570" data-spm-anchor-id="a313x.7781069.0.i1" class="selected"></path>
                    <path
                        ...
                        fill="#6965db" p-id="2571" data-spm-anchor-id="a313x.7781069.0.i8" class="selected"></path>
                    <path
                        ...
                        fill="#6965db" p-id="2572" data-spm-anchor-id="a313x.7781069.0.i9" class="selected"></path>
                    <path
                        ...
                        fill="#6965db" p-id="2573" data-spm-anchor-id="a313x.7781069.0.i4" class="selected"></path>
                    <path
                        ...
                        fill="#6965db" p-id="2574" data-spm-anchor-id="a313x.7781069.0.i10" class="selected"></path>
                </svg>
                <div class="tooltop">
                    消息
                    <div class="arrow"></div>
            ...
            <!-- 更多 -->
            <div class="more">
                <svg t="1683776195214" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    p-id="10290" width="200" height="200">
                    <path
